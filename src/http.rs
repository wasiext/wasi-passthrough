...
use crate::bindings::exports::wasi::http::types::IoErrorBorrow;
use crate::bindings::wasi::http::types::Duration;
...
use crate::bindings::wasi::http::{outgoing_handler, types};
...
impl From<exports::wasi::http::types::ErrorCode> for ErrorCode {
...
impl exports::wasi::http::outgoing_handler::Guest for () {
    fn handle(
    ...
    > {
        let res = outgoing_handler::handle(
            request.into_inner(),
            options.map(exports::wasi::http::types::RequestOptions::into_inner),
        )?;
        Ok(exports::wasi::http::types::FutureIncomingResponse::new(res))
    }
}

impl exports::wasi::http::types::Guest for () {
    type Fields = Fields;
    ...
    fn http_error_code(err: IoErrorBorrow<'_>) -> Option<exports::wasi::http::types::ErrorCode> {
        types::http_error_code(err.get()).map(Into::into)
    }
}

impl exports::wasi::http::types::GuestFields for Fields {
    fn new() -> Self {
        Self::new()
    }
